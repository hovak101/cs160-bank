      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Manage your checking, savings, and credit card products from one place.
          </p>
        </div>
        <OpenAccountForm />
      </div>

      <div className="rounded-3xl border border-white/10 bg-[#0f172a] p-5 text-sm text-slate-300">
        Checking supports flexible deposits and withdrawals. Savings earns
        <span className="font-semibold text-white"> {(SAVINGS_APY * 100).toFixed(2)}% APY</span>
        {" "}with a monthly withdrawal allowance capped at 10% of the month-opening balance. Credit cards stay compact here, while full terms, payment details, and account transactions live on a dedicated detail page.
      </div>
